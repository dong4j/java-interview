...
## 12. [String,StringBuffer, StringBuilder 的区别](string_kind.md)
...
## 17. [接口和抽象类的区别](abstract_interface.md)
...
[final、finally 和 finalize 的区别](final_finally_finalize.md)
